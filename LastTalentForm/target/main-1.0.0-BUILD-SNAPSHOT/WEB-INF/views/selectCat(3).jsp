...
<!-- 
    ...
    <button onclick="next()">확인</button> -->
 	<div style="margin-top:100px; margin-left:270px;">
    <h1>카테고리 선택</h1>
    <h2>최대 <span style="color : red;">5</span>개까지 선택 가능 합니다</h2>
    </div>
    <div class="_3MLvK _3Eqb6" style="margin-top:30px; margin-left:270px;">
	...
	<input style="margin-left: 970px; margin-top: 150px;" type="button" value="확인" onclick="go()" />
</div>		
    <script>
		...
		$("._1ya97").click(function(e){
			...
			if(className=="_1ya97 highlight"){
				...
				catdata.splice(catdatadata.indexOf(this.id),1);
				chcnt --;
			}
			if(chcnt>5){
