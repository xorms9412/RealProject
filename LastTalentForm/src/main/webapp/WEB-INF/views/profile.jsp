...
<html>
	...
	<body>
		...
		<div id="detailPop">
			...
			<img id="detailClose" width="15" src="resources/img/x.png" style="cursor: pointer;"/>
		</div>
		...
		<div id="modifyPop">
			...
			<img src = "resources/img/x.png" width="15" style="margin-top : 20px; cursor: pointer;" id="back"/>
		...
		<!-- 게시글들이 들어갈 장소 -->
			<section class="links" style="top:-550px;">
				<nav class="link-effect-10" id="link-effect-10">
					<a id="more" href="javascript:;" data-hover="더보기"><span>더보기</span></a>
				</nav>
			</section>
		</div>
			...
			$("#modify").click(function(){
				...
				cont += '<form id="sendForm2" action="modify" method="post">'
					...
					+'<select id="select" size="1" name="cat" style="display : block;">'
						...
						+'<input type="hidden" id="modifyEditable" name="content"/>'
				...
				$("#modifycontent").click(function(){
					$("#modifyEditable").val($("#editableModify").html());
					$("#sendForm2").submit();
					modifyDel();
				});
